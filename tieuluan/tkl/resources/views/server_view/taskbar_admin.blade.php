        ...
        <ul class="navbar-nav flex-fill w-100 mb-2">
            <li class="nav-item dropdown">
                <a href="#ui-elements" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle nav-link">
                    ...
                    <span class="ml-3 item-text">Thêm mới</span>
                </a>
            ...
            <li class="nav-item dropdown">
                <a href="#tables" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle nav-link">
                    ...
                    <span class="ml-3 item-text">Dữ liệu</span>
                </a>
                <ul class="collapse list-unstyled pl-4 w-100" id="tables">
                    ...
                    <li class="nav-item">
                        <a class="nav-link pl-3" href="./table_advanced.html"><span class="ml-1 item-text">CSDL kho hàng </span></a>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a class="nav-link pl-3" href="./table_datatables.html"><span class="ml-1 item-text">CSDL khách hàng</span></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link pl-3" href="./table_datatables.html"><span class="ml-1 item-text">CSDL loại đơn hàng</span></a>
                    </li>
                    <li class="nav-item">
