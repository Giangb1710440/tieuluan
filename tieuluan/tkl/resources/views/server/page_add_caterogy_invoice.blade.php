...
@section('title','Thêm mới loại hóa đơn')
@section('content')
    <main role="main" class="main-content">
        <div class="container-fluid">
            <div class="row justify-content-center">
                <div class="col-12">
                    <h2 class="page-title">Thêm mới loại hóa đơn</h2>
                    <p class="text-muted">Loại hóa đơn được đùng dể phân biệt các loại hóa đơn khi xuất nhập hàng</p>
                    <div class="row">
                        ...
                        <div class="col-md-10">
                            <div class="card shadow mb-4">
                                <div class="card-header">
                                    <strong class="card-title">Tên loại hóa đơn</strong>
                                </div>
                                <div class="card-body">
                                    <form class="needs-validation" action="{{route('post_add_caterogy_invoice')}}" method="post">
                                        @csrf
                                        <div class="form-group mb-3">
                                            <label for="exampleInputEmail1">Tên loại hóa đơn</label>
    ...
    <script>
        var msg = '{{Session::get('add_cate_invoice_success')}}';
        var exist = '{{Session::has('add_cate_invoice_success')}}';
        if (exist) {
